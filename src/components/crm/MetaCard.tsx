...
const MetaCard = ({ meta, lancamentos, onEdit, onDelete }: MetaCardProps) => {
  ...
  return (
    <div className={`bg-card border rounded-xl p-6 shadow-sm transition-all ${calc.metaBatida ? "border-success/40 bg-success/5" : "border-border"}`}>
      <div className="flex items-start justify-between mb-3">
        <h3 className="font-semibold text-card-foreground">{meta.nome}</h3>
